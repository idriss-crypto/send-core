...
const setup = (mode) => {
    ...
    return {
        ...
        LINEA_TESTNET_TIPPING_CONTRACT_ADDRESS: `'0xe18036D7E3377801a19d5Db3f9b236617979674E'`,
        OP_TIPPING_CONTRACT_ADDRESS: `'0x43F532D678b6a1587BE989a50526F89428f68315'`,
        PGN_TIPPING_CONTRACT_ADDRESS: `'0x43F532D678b6a1587BE989a50526F89428f68315'`,
        BASE_TIPPING_CONTRACT_ADDRESS: `'0x324Ad1738B9308D5AF5E81eDd6389BFa082a8968'`,
        MANTLE_TIPPING_CONTRACT_ADDRESS: `'0x324Ad1738B9308D5AF5E81eDd6389BFa082a8968'`,
        SCROLL_TIPPING_CONTRACT_ADDRESS: `'0x324ad1738b9308d5af5e81edd6389bfa082a8968'`,
        ALEPH_TIPPING_CONTRACT_ADDRESS: `'0xcA6742d2d6B9dBFFD841DF25C15cFf45FBbB98f4'`,
        ZERO_ADDRESS: `'0x0000000000000000000000000000000000000000'`,
...
module.exports = (env, argv) => {
    return {
        ...
        entry: {
            ...
            sendToAnyoneStyle:
                "!!css-loader!sass-loader!./src/sendToAnyoneStyle.scss",
            index: "./src/index.js",
            getWeb3Provider: "./src/getWeb3Provider.ts",
        },
        ...
        plugins: [new webpack.DefinePlugin(setup(argv.mode))],
